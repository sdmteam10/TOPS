      ...
      <div className='container-fluid'>
        <form className="mx-auto mt-md-5 font-monospace" id="2" onSubmit={this.submitForm}>
          ...
          <div className="mb-3">
            ...
            <input className="form-control" id="validationTextarea" placeholder="Required" name="whoIsManager" required ref={input=>this.whoIsManager=input} />
          </div>
          {/* Q2 */}
          <div className="mb-3">
            <label htmlFor="validationTextarea" className="form-label">2.	Where is an organisational chart available?</label>
            <textarea className="form-control" id="validationTextarea" placeholder="Required" name="whereIsChart" required ref={input=>this.whereIsChart=input}></textarea>
          </div>
          {/* Q3 */}
          <div className="mb-3">
            ...
            <textarea className="form-control" id="validationTextarea" placeholder="Required" ></textarea>
          </div>
          {/* Q4 */}
          <div className="mb-3">
            ...
            <textarea className="form-control" id="validationTextarea" placeholder="Required" name="funds" ref={input=>this.funds=input}></textarea>
          </div>
          {/* Q5*/}
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <textarea className="form-control" id="validationTextarea" placeholder="Required" name="vision" ref={input=>this.vision=input}> </textarea>
          </div>
          {/* Q7*/}
          <div className="mb-3">
            ...
            <textarea className="form-control" id="validationTextarea" placeholder="Required" name="product" ref={input=>this.product=input}></textarea>
          </div>
          {/* Q8*/}
          <div className="mb-3">
            <label htmlFor="validationTextarea" className="form-label">8.   What tools are used for company wide communications?</label>
            <textarea className="form-control" id="validationTextarea" placeholder="Required" name="tool" ref={input=>this.tool=input}> </textarea>
          </div>
          {/* Q9*/}
          <div className="mb-3">
